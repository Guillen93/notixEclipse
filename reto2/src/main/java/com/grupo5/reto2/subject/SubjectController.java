...
public class SubjectController {
	...
	public ResponseEntity<Iterable<SubjectServiceModel>> getSubjectByStudentDni(@PathVariable String studentDni)
			throws NotContentException {
	...
	public ResponseEntity<Iterable<SubjectServiceModel>> getSubjectByGradeEditionId(
			@PathVariable Integer gradeEditionId) throws NotContentException {
	...
	public ResponseEntity<Iterable<SubjectServiceModel>> getSubjectByProfessorDni(@PathVariable String professorDni)
			throws NotContentException {
	...
	@PutMapping("/subjectsUpdate/{subjectId}")
