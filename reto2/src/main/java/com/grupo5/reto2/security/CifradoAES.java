...
public class CifradoAES {
	 ...
	 */
	public String cifrarTexto(String clave, String mensaje, String userpass) {
		String ret = null;
		...
		try {
			...
			fileOutputStream = new FileOutputStream(FILE_PATH +userpass+".dat" );
	 ...
	 * @param clave La clave del usuario
	 */
	public String descifrarTexto(String clave,String userpass) {
		String ret = null;
		try {
			// Fichero leido
			File fichero = new File(FILE_PATH +userpass+".dat" );
	...
	private byte[] concatArrays(byte[] array1, byte[] array2) {
	 ...
	 //parte para cifrar las claves en los ficheros 
	
//	public static void main(String[] args) {
//		CifradoAES ejemploAES = new CifradoAES();
//		String mensaje = "notixDam@gmail.com";
//		System.out.println("Mensaje Original! -> " + mensaje);
//		System.out.println("-----------");
//		String mensajeCifrado = ejemploAES.cifrarTexto("Clave", mensaje,"user");
//		System.out.println("Mensaje Cifrado! -> " + mensajeCifrado);
//		System.out.println("-----------");
//		System.out.println("Mensaje Descifrado! -> " + ejemploAES.descifrarTexto("Clave","user"));
//		System.out.println("-----------");
//	}
}